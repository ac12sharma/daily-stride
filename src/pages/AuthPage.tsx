  ...
  return (
    <div className="min-h-screen app-bg flex flex-col items-center justify-center px-6 max-w-md mx-auto select-none">
      ...
      <motion.div
        ...
        <div className="w-16 h-16 bg-primary/10 glow-primary flex items-center justify-center rounded-full shadow-lg">
      ...
      <motion.div
        ...
        <button
          ...
          className="w-full gap-3 py-4 rounded-2xl glass-card-elevated text-foreground font-semibold text-sm press-effect flex-row flex items-center justify-center">
